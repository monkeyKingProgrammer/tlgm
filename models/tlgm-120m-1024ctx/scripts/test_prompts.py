...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/sft_tlgm_120m_polish.yaml")
    parser.add_argument("--checkpoint", default="checkpoints/tlgm_120m_1024ctx_sft_polished.pth")
    ...
    payload = torch.load(PROJECT_DIR / args.checkpoint, map_location=args.device)
